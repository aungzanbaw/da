...
Detail.create!(order:@o,name: "test",  qty:2, price:0, remark:"blar blar")
Detail.create!(order:@o,name: "test",  qty:3, price:0, remark:"blar blar")
Detail.create!(order:@o1,name: "test",  qty:4, price:120, remark:"blar blar")
Detail.create!(order:@o1,name: "test",  qty:5, price:1230, remark:"blar blar")
Detail.create!(order:@o1,name: "test",  qty:6, price:5230, remark:"blar blar")
Detail.create!(order:@o2,name: "test",  qty:7, price:0, remark:"blar blar")
Detail.create!(order:@o2,name: "test",  qty:8, price:0, remark:"blar blar")
Detail.create!(order:@o2,name: "test",  qty:9, price:0, remark:"blar blar")
Detail.create!(order:@o2,name: "test",  qty:10, price:0, remark:"blar blar")
Detail.create!(order:@o3,name: "test",  qty:21, price:0, remark:"blar blar")
